...
Gem::Specification.new do |spec|
  ...
  spec.description = %q{Execute a command after the system load dropped below a certain threshold. It can monitor the loadavg, harddisk and network activity. Support for keyboard and mouse usage monitoring in X11 (like a screensaver) is planned.}
  spec.summary     = %q{Execute a command after the system load dropped below a certain threshold}
